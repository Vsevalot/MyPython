...
class StartPage(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Example of results
        self.result_example_img = tk.PhotoImage(file="Images\\result_example.png")
        ...
        # Example of report
        self.report_example_img = tk.PhotoImage(file="Images\\report_examples.png")
        ...
        # No / Ok img
        no_img = tk.PhotoImage(file="Images\\no.png")
...
class Legend(tk.Frame):
    def __init__(self, parent):
        ...
        # Check buttons img
        self.stage_img = tk.PhotoImage(file="Images\\check.png")
        ...
        # Radio buttons img
        self.radio_img = tk.PhotoImage(file="Images\\radio.png")
        ...
        # Error formula
        self.err_img = tk.PhotoImage(file="Images\\error.png")
...
class PlotPage(tk.Toplevel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.legend.grid(row = 0, column = 4, rowspan = 3, sticky=(tk.N, tk.W), pady = (25, 0))

        # Toolbar
        self.toolbar_frame = tk.Frame(self.master_frame)
        self.toolbar_frame.grid(row = 3, column = 4)
        self.toolbar = NavigationToolbar2TkAgg(self.figure_canvas, self.toolbar_frame)
        self.toolbar.update()
